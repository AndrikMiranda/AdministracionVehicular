...
require 'funcs/funcs.php';
	...
	if (!empty($_POST)) {
		...
		$usuario = $mysqli->real_escape_string($_POST['nombreUsuario']);
		$contra = $mysqli->real_escape_string($_POST['contrasena']);
										...
										<div class="row row-bottom-padded-md">
											<form id="loginform" action="<?php $_SERVER['PHP_SELF'] ?>" class="col-md-6 to-animate" method="post">
												<div class="form-group">
													<label for="usuario" class="sr-onlyy">Usuario</label>
													<h1> </h1>
													<input id="nombreUsuario" type="text" class="form-control" name="nombreUsuario" value="" placeholder="&#128100; Usuario o email" required>
												</div>
												<h1> </h1>
												<div class="form-group">
												...
												<div class="form-group ">
													<button class="btn btn-primary btn-lg" id="btn-login" type="submit" name="button">Iniciar sesión</a>
												</div>
												<a href="RecuperaContrasena.php">¿Olvidaste tu contraseña?</a>
											</form>
