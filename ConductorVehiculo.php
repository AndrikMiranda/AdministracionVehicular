		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Asigar vehiculo a Conductor</span></a></li>
              <?php } ?>
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     ...
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Asignar vehículo a Conductor</h2>
       <div class="row">
         <h3 class="to-animate">Consulta (Prueba)</h3>
         <div class="col-md-7 col-md-offset-3 subtext to-animate">
             <table>
               <thead>
                 <tr>
               ...
               <?php
               $consulta = "SELECT idConductor, nombre, apellidos, correo, telefono FROM conductor WHERE idVehiculo IS NULL";
               $resultado = $mysqli->query($consulta);
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                     ...
                     <tr>
                       ...
                       <td><a href="asignarVC.php?idConductor=<?php echo $row['idConductor']; ?>">
