...
if (!empty($_GET)) {
  ...
  $sqlll = "DELETE FROM SocioConductor WHERE idSocio = '$id'";

  $del = $mysqli->query($sqlll);

  $sqll = "DELETE FROM SocioVehiculo WHERE idSocio = '$id'";

  $dell = $mysqli->query($sqll);

  $sqllll = "DELETE FROM socio WHERE idSocio = '$id'";
  $delll = $mysqli->query($sqllll);
} else {
  echo "nel we";
  echo $id;
}
 ...
 <section id="fh5co-home" data-section="home" style="background-image: url(images/full_image_2.jpg);" data-stellar-background-ratio="0.5">
	 ...
	 <div class="container">
		 <div class="text-wrap">
            ...
            <h1>Socio eliminado exitosamente!</h1>      
