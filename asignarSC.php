		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Asignar socio</span></a></li>
              <?php } ?>
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="updateSC.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         <h3>Asignar a conductor o repartidor un socio</h3>
         ...
         <div class="form-group">
           <select class="form-control" name="idSocio">
             ...
             $consulta1 = "SELECT idSocio, nombre, apellido, correo  FROM socio";
             $resultado1 = $mysqli->query($consulta1);
             while ($row1 = $resultado1 ->fetch_array(MYSQL_ASSOC)) { ?>

             <option value="<?php echo $row1['idSocio']; ?>"><?php echo $row1['idSocio']; ?>
