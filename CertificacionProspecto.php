...
// REGISTRO DE PROSPECTO UBER

	if (!empty($_POST)) {
		$nombreC = $mysqli->real_escape_string($_POST['nombre']);
		$apellidoC = $mysqli->real_escape_string($_POST['apellido']);
		$telefonoC = $mysqli->real_escape_string($_POST['telefono']);
    $tipoCertificado = $mysqli->real_escape_string($_POST['idCertificado']);

		if (isNullProspecto($nombreC, $apellidoC, $telefonoC, $tipoCertificado)) {
			$errors[] = "Debe llenar todos los campos.";
		}

    if (telefonoExiste($telefonoC)) {
      $errors[] = "El telefono ingresado y existe favor de verificar";
    } else {

      $registroC = registrarProspecto($nombreC, $apellidoC, $telefonoC, $tipoCertificado);
    ...
    if ($registroC > 0) {
      ...
      $errors[] = "Error al registrar prospecto.";
    }
...
<link rel="icon" href="images/favicon.ico">
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Registro de Prospecto</span></a></li>
              <?php } ?>
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">Registro de Prospecto</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" autocomplete="off" class="col-md-6 to-animate">
         ...
         <input id="nombre" class="form-control" placeholder="Nombre" name="nombre" type="text" value="<?php if (isset($nombreC)) echo $nombreC; ?>">
         </div>
         <div class="form-group ">
         <label for="apellido" class="sr-only">Apellido</label>
         <input id="apellido" class="form-control" placeholder="Apellido" name="apellido" type="text" value="<?php if (isset($apellidoC)) echo $apellidoC; ?>">
         </div>
         <div class="form-group ">
         <label for="telefono" class="sr-only">Teléfono</label>
         <input id="telefono" class="form-control" placeholder="Teléfono" name="telefono" type="text" value="<?php if (isset($telefonoC )) echo $telefonoC; ?>">
         </div>
         <input id="idCertificado" class="" placeholder="" name="idCertificado" type="hidden" value="1">
   ...
   <div class="row">
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Certificación de Prospectos</h2>
       <div class="row">
         <h3 class="to-animate">Consulta (Prueba)</h3>
         <div class="col-md-4 col-md-offset-4 subtext to-animate">
             <table>
               <thead>
                 <tr>
               ...
               <?php
               $consulta = "SELECT idConductor, nombre, apellidos, telefono, idCertificado  FROM conductor WHERE idCertificado = 1";
               $resultado = $mysqli->query($consulta);
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                     ...
                     <tr>
                       ...
                       <td><?php if ($row['idCertificado'] == 1): echo 'NoCertificado'; endif;?></td>

                       <td><a href="actualizarCertificado.php?idConductor=<?php echo $row['idConductor']; ?>">
                       <span class="glyphicon glyphicon-pencil"></span></a></td>
                       <td><a href="eliminarProspecto.php?idConductor=<?php echo $row['idConductor']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
                       </tr>
                     </tr>
               <?php
                 }
     ...
     <div class="modal-dialog">
       <div class="modal-content">
         <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel">Eliminar prospecto</h4>
         </div>
         ...
         <div class="modal-footer">
           ...
           <a class="btn btn-danger btn-ok" href="eliminarProspecto.php">Eliminar</a>
         </div>
       </div>
     </div>
