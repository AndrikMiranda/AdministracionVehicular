 ...
 <section id="fh5co-testimonials" data-section="RegistroSocio">
   <div class="row">
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Consulta de socio y sus conductores</h2>
       <div class="row">
         <div class="col-md-10 col-md-offset-1 subtext to-animate">
             <h3 class="to-animate">Selecciona un socio para accesar a sus conductores</h3>
                 ...
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                   ...
                   $row3 = $resultado3 ->fetch_array(MYSQL_ASSOC);
                     ...
                     <tr>
                       ...
                       <td><a href="ConsultaConductoresDeSocio.php?idSocio=<?php echo $row['idSocio']; ?>">
