   ...
   <div class="container">
    <div class="row">
     <div class="col-md-12 section-heading text-center">
       ...
       <div class="row">
         <h3 class="to-animate">Prospectos certificados</h3>
         <div class="col-md-8 col-md-offset-3 subtext to-animate">
             <table>
               <thead>
                 <tr>
               ...
               <?php
               $consulta = "SELECT idConductor, nombre, apellidos, idCertificado  FROM conductor WHERE idCertificado > 1";
               $resultado = $mysqli->query($consulta);
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                     ...
                     <tr>
                       ...
                       <td><?php if ($row['idCertificado'] == 1): echo 'NoCertificado'; endif;?>
                           <?php if ($row['idCertificado'] == 2): echo 'Uber X'; endif;?>
                           <?php if ($row['idCertificado'] == 3): echo 'Uber Eats'; endif;?>
                           <?php if ($row['idCertificado'] == 4): echo 'Ambos'; endif;?>
                       </td>

                       <td><a href="RegistroConductor.php?idConductor=<?php echo $row['idConductor']; ?>">
