...
// LOGIN DE USUARIOS -----------------------------------------------------------------------------
  ...
  $sqll = "SELECT * FROM socio WHERE idSocio = '$id'";
...
<link rel="icon" href="images/favicon.ico">
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "ModificarSocio"><span>Modificar socio</span></a></li>
              <?php } ?>
 ...
 <?php if($_SESSION['tipo']==4 || $_SESSION['tipo']==1) { ?>
 <section id="fh5co-testimonials" data-section="ModificarSocio">
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">Modificar Socio</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="socioform" role="form" action="updateSocio.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         <h3>Modificar datos de Socio</h3>
         <div id="socioalert" style="display:none">
           <p>Error:</p>
           <span></span>
         </div>
         ...
         <div class="form-group ">
           ...
           <input id="apellido" class="form-control" placeholder="Apellidos" name="apellido" type="text" value="<?php echo $col['apellido']; ?>">
         </div>
         <div class="form-group ">
