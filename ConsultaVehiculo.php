...
if (!empty($_POST)) {
  ...
  if (isNullVehiculo($idMarca, $idModelo, $idColor, $Ano, $matricula)) {
    $errors[] = "Debe llenar todos los campos.";
  }

  if (matriculaExistente ($matricula)) {
    $errors[] = "La matricula: $matricula, ya esta registrada en el sistema";

  } else

    $registroV = registrarVehiculo($idMarca, $idModelo, $idColor, $Ano, $matricula);
...
<link rel="icon" href="images/favicon.ico">
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Admin. de vehiculo</span></a></li>
              <?php } ?>
 ...
 <section id="fh5co-home" data-section="home" style="background-image: url(images/calle.jpg);" data-stellar-background-ratio="0.5">
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">Registrar de Vehículo</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" autocomplete="off" class="col-md-6 to-animate">
         ...
         <div class="form-group ">
           ...
           <input id="matricula" class="form-control" placeholder="Matrícula" name="matricula" type="text" value="<?php if (isset($matricula)) echo $matricula; ?>">
         </div>
           <br>
   ...
   <div class="row">
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Consulta de Vehículo</h2>
       <div class="row">
         <div class="col-md-8 col-md-offset-2 subtext to-animate">
             <h3 class="to-animate">Consulta (Prueba)</h3>
              <a href="ConsultaVehiculo0.php"><button type="button" name="button" class="btn btn-primary btn-lg">Consulta por Matricula</button></a>
              <br>
              <br>
              <br>
             <table>
               ...
               <?php
               $consulta = "SELECT idVehiculo, idMarca, idModelo, idColor, ano, matricula FROM vehiculo";
               $resultado = $mysqli->query($consulta);
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                   $consulta3 = "SELECT nombreMarca FROM marca WHERE idMarca = ".$row['idMarca']."";
                   $resultado3 = $mysqli->query($consulta3);
                   $row3 = $resultado3 ->fetch_array(MYSQL_ASSOC);

                   $consulta2 = "SELECT nombreModelo FROM modelo WHERE idModelo = ".$row['idModelo']."";
                   $resultado2 = $mysqli->query($consulta2);
                   $row2 = $resultado2 ->fetch_array(MYSQL_ASSOC);

                   $consulta4 = "SELECT color FROM colorVehiculo WHERE idColor = ".$row['idColor']."";
                   $resultado4 = $mysqli->query($consulta4);
                   $row4 = $resultado4 ->fetch_array(MYSQL_ASSOC);
                     ?>
                     <tr>
                       <td><?php echo $row['idVehiculo']; ?></td>
                       <td><?php echo $row3['nombreMarca']; ?></td>
                       <td><?php echo $row2['nombreModelo']; ?></td>
                       <td><?php echo $row4['color']; ?></td>
                       <td><?php echo $row['ano']; ?></td>
                       <td><?php echo $row['matricula']; ?></td>
                       <td><a href="modificarVehiculo.php?idVehiculo=<?php echo $row['idVehiculo']; ?>">
                       <span class="glyphicon glyphicon-pencil"></span></a></td>
                       <td><a href="eliminarVehiculo.php?idVehiculo=<?php echo $row['idVehiculo']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
         							</tr>
                     </tr>
               <?php
                 }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger btn-ok" href="eliminarVehiculo.php">Eliminar</a>
        </div>
      </div>
    </div>
