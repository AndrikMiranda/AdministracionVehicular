...
<link rel="icon" href="images/favicon.ico">
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "ModificarConductor"><span>Modificar Conductor</span></a></li>
              <?php } ?>
 ...
 <?php if($_SESSION['tipo']==4 || $_SESSION['tipo']==1) { ?>
 <section id="fh5co-testimonials" data-section="ModificarConductor">
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">Modificar Conductor</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="conductorform" role="form" action="updateConductor0.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         <h3>Modificar datos de Conductor</h3>
         <div id="conductoralert" style="display:none">
           <p>Error:</p>
           <span></span>
         </div>
         <div class="form-group ">
           <label for="matricula" class="sr-only">Nombre</label>
         ...
         <?php
         $aano = date('Y')-18;
         echo '<input id="fechaN" class="form-control" placeholder="Fecha de Nacimiento" name="fechaN" type="date" min="1920-01-01" max="'.$aano.'-01-01"value="'.$col["fechaN"].'">';
         ?>
         </div>
         <div class="form-group ">
         ...
         <div class="form-group ">
           ...
           <input id="direccion" class="form-control" placeholder="Dirección" name="direccion" type="text" value="<?php echo $col['direccion']; ?>">
         </div>
         <div class="form-group ">
           <label for="matricula" class="sr-only">Correo</label>
           <input id="correo" class="form-control" placeholder="Correo" name="correo" type="text" value="<?php echo $col['correo']; ?>">
         </div>
         <div class="form-group ">
           <label for="saldoNegativo" class="sr-only">Saldo Negativo</label>
           <input id="saldoNegativo" class="form-control" placeholder="Saldo Negativo" name="saldoNegativo" type="text" value="<?php echo $col['saldoNegativo']; ?>">
         </div>
         <div class="form-group">
           <select class="form-control" name="credito">
             <option value="-2"<?php if ($col['credito']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="0"<?php if ($col['credito']=='0') echo 'selected';?>>Vehículo a crédito - No</option>
             <option value="1"<?php if ($col['credito']=='1') echo 'selected';?>>Vehículo a crédito - Sí</option>

           </select>
         </div>
         <div class="form-group">
           <select class="form-control" name="idEstado">
             <option value="-2"<?php if ($col['idEstado']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="1"<?php if ($col['idEstado']=='1') echo 'selected';?>>Chihuahua</option>
             <option value="2"<?php if ($col['idEstado']=='2') echo 'selected';?>>Verde</option>
             <option value="3"<?php if ($col['idEstado']=='3') echo 'selected';?>>Azul</option>
             <option value="4"<?php if ($col['idEstado']=='4') echo 'selected';?>>Negro</option>
           </select>
         </div>
         <div class="form-group">
           <select class="form-control" name="idCiudad">
             <option value="-2"<?php if ($col['idCiudad']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="1"<?php if ($col['idCiudad']=='1') echo 'selected';?>>Chihuahua</option>
             <option value="2"<?php if ($col['idCiudad']=='2') echo 'selected';?>>2016</option>
             <option value="3"<?php if ($col['idCiudad']=='3') echo 'selected';?>>2017</option>
             <option value="4"<?php if ($col['idCiudad']=='4') echo 'selected';?>>2018</option>
           </select>
         </div>
         <div class="form-group">
           <select class="form-control" name="idCertificado">
             <option value="-2"<?php if ($col['idCertificado']=='-2') echo 'selected';?>>----------------------------</option>
             ...
             <option value="4"<?php if ($col['idCertificado']=='4') echo 'selected';?>>Uber X y Uber Eats</option>
           </select>
         </div>
