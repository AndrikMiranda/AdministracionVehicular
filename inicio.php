...
<link rel="icon" href="images/favicon.ico">
 ...
 <header role="banner" id="fh5co-header">
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
               ...
               <li><a href="#" data-nav-section= "work"><span>Menú</span></a></li>
 ...
 <section id="fh5co-home" data-section="home" style="background-image: url(images/carros.jpg);" data-stellar-background-ratio="0.5">
   ...
   <div class="container">
     <div class="row">
      ...
      <div class="col-md-4 col-sm-6 col-xxs-12">
       <a href="ConsultaVehiculo.php">
         <div class="fh5co-project-item to-animate">
           <img src="images/auto.jpg" alt="Image" class="img-responsive">
           <div class="fh5co-text">
           <h1>Admin. Vehículo </h1>
           </div>
         </div>
         </a>
       </div>
      ...
      <div class="col-md-4 col-sm-6 col-xxs-12">
       ...
       <?php if($_SESSION['tipo']==4 || $_SESSION['tipo']==1) { ?>
      <div class="col-md-4 col-sm-6 col-xxs-12">
       <a href="CertificacionProspecto.php">
         <div class="fh5co-project-item to-animate">
           <img src="images/auto.jpg" alt="Image" class="img-responsive">
           <div class="fh5co-text">
           <h1>Certificar Prospecto</h1>
           </div>
         </div>
         </a>
       </div>
      ...
      <div class="col-md-4 col-sm-6 col-xxs-12">
       ...
       <?php if($_SESSION['tipo']==4 ) { ?>
       <div class="col-md-4 col-sm-6 col-xxs-12">
         <a href="signup.php" class="fh5co-project-item to-animate">
         <div>
           <img src="images/auto.jpg" alt="Image" class="img-responsive">
           <div class="fh5co-text">
      ...
      <?php if($_SESSION['tipo']==4 ) { ?>
      <div class="col-md-4 col-sm-6 col-xxs-12">
        <a href="CompletarConductor.php" class="fh5co-project-item to-animate">
        <div>
          <img src="images/auto.jpg" alt="Image" class="img-responsive">
          <div class="fh5co-text">
       ...
       <?php if($_SESSION['tipo']==4 ) { ?>
       <div class="col-md-4 col-sm-6 col-xxs-12">
         <a href="SocioVehiculo.php" class="fh5co-project-item to-animate">
         <div>
           <img src="images/auto.jpg" alt="Image" class="img-responsive">
           <div class="fh5co-text">
           <h1>SocioVehículo</h1>
        ...
        <?php if($_SESSION['tipo']==4 ) { ?>
        <div class="col-md-4 col-sm-6 col-xxs-12">
          <a href="SocioConductor.php" class="fh5co-project-item to-animate">
          <div>
            <img src="images/auto.jpg" alt="Image" class="img-responsive">
            <div class="fh5co-text">
            <h1>SocioConductor</h1>
            </div>
          </div>
         </a>
       </div>
         ...
         <?php if($_SESSION['tipo']==4 ) { ?>
         <div class="col-md-4 col-sm-6 col-xxs-12">
           <a href="consultaSocio.php" class="fh5co-project-item to-animate">
           <div>
             <img src="images/auto.jpg" alt="Image" class="img-responsive">
             <div class="fh5co-text">
             <h1>Consulta Socio</h1>
             </div>
           </div>
          </a>
        </div>
        ...
        <?php if($_SESSION['tipo']==4 ) { ?>
        <div class="col-md-4 col-sm-6 col-xxs-12">
          <a href="ConductorVehiculo.php" class="fh5co-project-item to-animate">
           <div>
            <img src="images/auto.jpg" alt="Image" class="img-responsive">
            <div class="fh5co-text">
            <h1>Vehículo-Conductor</h1>
            </div>
          </div>
         </a>
       </div>
         ...
         <?php if($_SESSION['tipo']==4 ) { ?>
          <div class="col-md-4 col-sm-6 col-xxs-12">
           <a href="ConsultaConductor.php" class="fh5co-project-item to-animate">
            <div>
             <img src="images/auto.jpg" alt="Image" class="img-responsive">
             <div class="fh5co-text">
             <h1>Consulta Conductor</h1>
            </div>
           </div>
          </a>
        </div>
      ...
      <?php if($_SESSION['tipo']==4 ) { ?>
      <div class="col-md-4 col-sm-6 col-xxs-12">
        <a href="ConsultaSYC.php" class="fh5co-project-item to-animate">
         <div>
          <img src="images/auto.jpg" alt="Image" class="img-responsive">
          <div class="fh5co-text">
          <h1>ConsultaCdeS</h1>
