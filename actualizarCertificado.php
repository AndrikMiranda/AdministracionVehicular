		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Actualizar Certificado</span></a></li>
              <?php } ?>
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">Actualizar Certificado</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="updateProspecto.php" method="post" autocomplete="off" class="col-md-6 to-animate">
