...
// LOGIN DE USUARIOS -----------------------------------------------------------------------------
  ...
  $sqll = "SELECT * FROM vehiculo WHERE idVehiculo = '$id'";
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Registro de Vehículo</span></a></li>
              <?php } ?>
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">modificar Vehículo</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="updateAutomovil.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         <h3>Modificar datos de vehiculo</h3>
         ...
         <div class="form-group">
           <select class="form-control" name="marca">
             <option value="-2"<?php if ($col['idMarca']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="1"<?php if ($col['idMarca']=='1') echo 'selected';?>>Ford</option>
             <option value="2"<?php if ($col['idMarca']=='2') echo 'selected';?>>Chevrolet</option>
             <option value="3"<?php if ($col['idMarca']=='3') echo 'selected';?>>Nissan</option>
             <option value="4"<?php if ($col['idMarca']=='4') echo 'selected';?>>Peugeot</option>
           </select>
         </div>
         <div class="form-group">
           <select class="form-control" name="modelo">
             <option value="-2"<?php if ($col['idModelo']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="1"<?php if ($col['idModelo']=='1') echo 'selected';?>>Fiesta</option>
             <option value="2"<?php if ($col['idModelo']=='2') echo 'selected';?>>Spark</option>
             <option value="3"<?php if ($col['idModelo']=='3') echo 'selected';?>>Sentra</option>
             <option value="4"<?php if ($col['idModelo']=='4') echo 'selected';?>>*</option>
           </select>
         </div>
         <div class="form-group">
           <select class="form-control" name="color">
             <option value="-2"<?php if ($col['idColor']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="1"<?php if ($col['idColor']=='1') echo 'selected';?>>Rojo</option>
             <option value="2"<?php if ($col['idColor']=='2') echo 'selected';?>>Verde</option>
             <option value="3"<?php if ($col['idColor']=='3') echo 'selected';?>>Azul</option>
             <option value="4"<?php if ($col['idColor']=='4') echo 'selected';?>>Negro</option>
           </select>
         </div>
         <div class="form-group">
           <select class="form-control" name="año">
             <option value="-2"<?php if ($col['ano']=='-2') echo 'selected';?>>----------------------------</option>
             <option value="2015"<?php if ($col['ano']=='2015') echo 'selected';?>>2015</option>
             <option value="2016"<?php if ($col['ano']=='2016') echo 'selected';?>>2016</option>
             <option value="2017"<?php if ($col['ano']=='2017') echo 'selected';?>>2017</option>
             <option value="2018"<?php if ($col['ano']=='2018') echo 'selected';?>>2018</option>
           </select>
         </div>
         <div class="form-group ">
           <label for="matricula" class="sr-only">Matrícula</label>
           <input id="matricula" class="form-control" placeholder="Matrícula" name="matricula" type="text" value="<?php echo $col['matricula']; ?>">
           <input id="idVehiculo" name="idVehiculo" type="hidden" value="<?php echo $col['idVehiculo']; ?>">
         </div>
           <br>
