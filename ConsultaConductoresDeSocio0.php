       ...
       <div class="row">
         <div class="col-md-10 col-md-offset-1 subtext to-animate">
             ...
             <table>
               ...
               $consulta5 = "SELECT * FROM conductor WHERE idConductor = ".$row4['idConductor']."";
               $resultado5 = $mysqli->query($consulta5);
               $row5 = $resultado5 ->fetch_array(MYSQL_ASSOC);


               $consulta3 = "SELECT nombreEstado FROM estado WHERE idEstado = ".$row5['idEstado']."";
               $resultado3 = $mysqli->query($consulta3);
               $row3 = $resultado3 ->fetch_array(MYSQL_ASSOC);

               $consulta2 = "SELECT nombreCiudad FROM ciudad WHERE idCiudad = ".$row5['idCiudad']."";
               $resultado2 = $mysqli->query($consulta2);
               $row2 = $resultado2 ->fetch_array(MYSQL_ASSOC);

               $consulta1 = "SELECT certificado FROM certificado WHERE idCertificado = ".$row5['idCertificado']."";
               $resultado1 = $mysqli->query($consulta1);
               $row1 = $resultado1 ->fetch_array(MYSQL_ASSOC);

               $consulta0 = "SELECT idMarca, idModelo, matricula FROM vehiculo WHERE idVehiculo = ".$row5['idVehiculo']."";
               $resultado0 = $mysqli->query($consulta0);
               $row0 = $resultado0 ->fetch_array(MYSQL_ASSOC);

               $consulta6 = "SELECT nombreModelo FROM modelo WHERE idModelo = ".$row0['idModelo']."";
               $resultado6 = $mysqli->query($consulta6);
               $row6 = $resultado6 ->fetch_array(MYSQL_ASSOC);

               $consulta7 = "SELECT nombreMarca FROM marca WHERE idMarca = ".$row0['idMarca']."";
               $resultado7 = $mysqli->query($consulta7);
               $row7 = $resultado7 ->fetch_array(MYSQL_ASSOC);
                     ...
                     <tr>
                       ...
                       <td><?php echo $row1['certificado']; ?></td>
                       <td><?php echo $row7['nombreMarca']; echo " | ";
                                 echo $row6['nombreModelo']; echo " | ";
                                 echo $row0['matricula']; ?></td>
