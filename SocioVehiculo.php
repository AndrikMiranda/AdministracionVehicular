		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Asigar vehiculo a Socio</span></a></li>
              <?php } ?>
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     ...
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Asignar vehículo a socio</h2>
       <div class="row">
         ...
         <div class="col-md-8 col-md-offset-3 subtext to-animate">
             <table>
               ...
               <?php
               $consulta = "SELECT idSocio, nombre, apellido, correo FROM socio";
               $resultado = $mysqli->query($consulta);
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                     ...
                     <tr>
                       ...
                       <td><a href="asignarVS.php?idSocio=<?php echo $row['idSocio']; ?>">
