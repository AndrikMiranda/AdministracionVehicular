		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Asignar socio a conductor</span></a></li>
              <?php } ?>
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     ...
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Asignar socio a conductor</h2>
       <div class="row">
         ...
         <div class="col-md-8 col-md-offset-2 subtext to-animate">
             <table>
               ...
               <?php
               $consulta = "SELECT DISTINCT * FROM conductor WHERE NOT EXISTS
               (SELECT idConductor FROM socioConductor WHERE socioConductor.idConductor = conductor.idConductor)";
               $resultado = $mysqli->query($consulta);
               while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) { ?>


                     <tr>
                       <td><?php echo $row['idConductor']; ?></td>
                       <td><?php echo $row['nombre']; ?></td>
                       <td><?php echo $row['apellidos']; ?></td>
                       <td><?php echo $row['correo']; ?></td>
                       <td><?php
                       if ($row['idCertificado'] == 2) {
                         echo "Uber X";
                       }
                       if ($row['idCertificado'] == 3) {
                         echo "Uber Eats";
                       }
                       if ($row['idCertificado'] == 4) {
                         echo "Uber X y Uber Eats";
                       }
                       ?></td>

                       <td><a href="asignarSC.php?idConductor=<?php echo $row['idConductor']; ?>">
