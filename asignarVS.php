...
<link rel="icon" href="images/favicon.ico">
 ...
 <?php if($_SESSION['tipo']==4 || $_SESSION['tipo']==1) { ?>
   <?php
   $consulta = "SELECT * FROM socio WHERE idSocio = '$id'";
 ...
 <section id="fh5co-testimonials" data-section="RegistroVehiculo">
   <div class="container">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="updateVS.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         <h3>Asignar vehículo a un socio</h3>
         ...
         <div class="form-group ">
           ...
           <h1> <?php echo $row['nombre'];  ?> <?php echo $row['apellido'];  ?> </h1>
           <input id="idSocio" name="idSocio" type="hidden" value="<?php echo $row['idSocio']; ?>">
         </div>
         <div class="form-group">
           <select class="form-control" name="idVehiculo">
             <?php
             $consulta5 = "SELECT idVehiculo FROM socioVehiculo";
             $resultado5 = $mysqli->query($consulta5);
             $row5 = $resultado5 ->fetch_array(MYSQL_ASSOC);



             $consulta1 = "SELECT DISTINCT * FROM vehiculo WHERE NOT EXISTS
             (SELECT idVehiculo FROM socioVehiculo WHERE socioVehiculo.idVehiculo = vehiculo.idVehiculo)";
