 ...
 <section id="fh5co-testimonials" data-section="RegistroSocio">
   <div class="row">
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Consulta conductores de socio <?php echo $col['nombre']; ?></h2>
       <div class="row">
         <div class="col-md-10 col-md-offset-1 subtext to-animate">
             <h3 class="to-animate">Consulta (Prueba)</h3>
             <h3 class="to-animate"><?php echo $col['nombre']; echo " "; echo $col['apellido']; ?></h3>
             <table>
               <thead>
                 <tr>
                   ...
                   <th width="200">Saldo Negativo</th>
               ...
               <?php
               $consulta4 = "SELECT idConductor FROM socioConductor WHERE idSocio = '$id'";
               $resultado4 = $mysqli->query($consulta4);
               while ($row4 = $resultado4 ->fetch_array(MYSQL_ASSOC)) {

               $consulta5 = "SELECT conductor.nombre, conductor.apellidos, conductor.fechaN,
               conductor.telefono, conductor.direccion, conductor.correo, conductor.saldoNegativo,
               estado.nombreEstado, ciudad.nombreCiudad, certificado.certificado, vehiculo.matricula
               FROM conductor  INNER JOIN estado ON conductor.idEstado = estado.idEstado
               INNER JOIN ciudad ON conductor.idCiudad = ciudad.idCiudad
               INNER JOIN certificado ON conductor.idCertificado = certificado.idCertificado
               INNER JOIN vehiculo ON conductor.idVehiculo = vehiculo.idVehiculo
               WHERE conductor.idConductor = ".$row4['idConductor']."";
               $resultado5 = $mysqli->query($consulta5);

               $consulta6 = "SELECT * FROM conductor WHERE idConductor = ".$row4['idConductor']."";
               $resultado6 = $mysqli->query($consulta6);
               while ($row5 = $resultado5 ->fetch_array(MYSQL_ASSOC)) {

                     ?>
                     <tr>
                       <td><?php echo $row5['nombre']; ?></td>
                        <td><?php echo $row5['apellidos']; ?></td>
                       <td><?php echo $row5['fechaN']; ?></td>
                       <td><?php echo $row5['telefono']; ?></td>
                       <td><?php echo $row5['direccion']; ?></td>
                       <td><?php echo $row5['correo']; ?></td>
                       <td><?php echo $row5['saldoNegativo']; ?></td>
                       <td><?php echo $row5['nombreEstado']; ?></td>
                       <td><?php echo $row5['nombreCiudad']; ?></td>
                       <td><?php echo $row5['certificado']; ?></td>
                       <td><?php echo $row5['matricula']; ?></td>
