...
// CONSULTA DE Conductor UBER

$where = "";
if (!empty($_POST)) {
  $valor = $_POST['nombre'];
  if (!empty($valor)) {
    $where = "WHERE nombre LIKE '%$valor%' AND idCertificado > 1";
  }
} if (empty($_POST['nombre'])) {
  $where = "WHERE idCertificado > 1";
}

$consulta = "SELECT * FROM conductor $where";
...
<link rel="icon" href="images/favicon.ico">
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroConductor"><span>Consulta de Conductor</span></a></li>
              <?php } ?>
 ...
 <?php if($_SESSION['tipo']==4 || $_SESSION['tipo']==1) { ?>
 <section id="fh5co-testimonials" data-section="RegistroConductor">
   <div class="row">
     <div class="col-md-12 section-heading text-center">
       <h2 class="to-animate">Consulta de Conductor</h2>
       <div class="row">
             ...
             <table>
               <thead>
                 <tr>
                   ...
                   <th width="300">SaldoNegativo</th>
                   <th width="300">Vehiculo a credito</th>
                   <th width="300">Estado</th>
                   <th width="300">Ciudad</th>
                   <th width="300">Certificado de prospecto</th>
                   <th width="300">Vehículo asignado</th>
                   <th width="100"> </th>
                   <th width="100"> </th>
                 </tr>
               </thead>
               ...
               <?php
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                     ...
                     <tr>
                       ...
                       <td><?php echo $row['saldoNegativo']; ?></td>
                       ...
                       <td><a href="modificarConductor.php?idConductor=<?php echo $row['idConductor']; ?>">
                       <span class="glyphicon glyphicon-pencil"></span></a></td>
                       <td><a href="eliminarConductor.php?idConductor=<?php echo $row['idConductor']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
         							</tr>
                     </tr>
               <?php
                 }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger btn-ok" href="eliminarConductor.php">Eliminar</a>
