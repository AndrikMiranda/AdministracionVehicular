...
<link rel="icon" href="images/favicon.ico">
		 ...
		 <div class="container">
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="#" data-nav-section= "RegistroVehiculo"><span>Asignar vehículo</span></a></li>
              <?php } ?>
 ...
 <?php if($_SESSION['tipo']==4 || $_SESSION['tipo']==1) { ?>
   <?php
   $consulta = "SELECT * FROM conductor WHERE idConductor = '$id'";
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12 section-heading text-center">
         <h2 class="to-animate">Asignar vehículo</h2>
         <div class="row">
     ...
     <div class="row row-bottom-padded-md">
       ...
       <form id="vehiculoform" role="form" action="updateVC.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         <h3>Asignar vehículo a un conductor</h3>
         ...
         <div class="form-group ">
           ...
           <h1> <?php echo $row['nombre'];  ?> <?php echo $row['apellidos'];  ?> </h1>
           <input id="idConductor" name="idConductor" type="hidden" value="<?php echo $row['idConductor']; ?>">
         </div>
         <div class="form-group">
           <select class="form-control" name="idVehiculo" id="idVehiculo">
             <?php
             $consulta11 = "SELECT idVehiculo FROM conductor WHERE NOT idVehiculo IS NULL";
             $resultado11 = $mysqli->query($consulta11);
             while ($row11 = $resultado11 ->fetch_array(MYSQL_ASSOC)){

             $consulta1 = "SELECT * FROM vehiculo WHERE idVehiculo != ".$row11['idVehiculo']."";
             $resultado1 = $mysqli->query($consulta1);
             while ($row1 = $resultado1 ->fetch_array(MYSQL_ASSOC)) {
             ?>

               <option value="<?php echo $row1['idVehiculo']; ?>"><?php echo $row1['idVehiculo']; ?>
                 <?php

                 $consulta3 = "SELECT nombreMarca FROM marca WHERE idMarca = ".$row1['idMarca']."";
                 $resultado3 = $mysqli->query($consulta3);
                 $row3 = $resultado3 ->fetch_array(MYSQL_ASSOC);
                 echo " | ";
                 echo $row3['nombreMarca'];

                 $consulta2 = "SELECT nombreModelo FROM modelo WHERE idModelo = ".$row1['idModelo']."";
                 $resultado2 = $mysqli->query($consulta2);
                 $row2 = $resultado2 ->fetch_array(MYSQL_ASSOC);
                 echo " | ";
                 echo $row2['nombreModelo'];

                 $consulta4 = "SELECT color FROM colorVehiculo WHERE idColor = ".$row1['idColor']."";
