	...
	if (!empty($_POST)) {
		...
		if (!isEmail($correo)) {
				...
				if (emailExistente($correo)) {
					 $user_id = getValor('idUsuario', 'correo', $correo);
					 $nombre = getValor('nombreUsuario', 'correo', $correo);

					 $token = generateTokenPass($user_id);

					$url = 'http://'.$_SERVER["localhost"].
					'localhost/uberdost/cambia_pass.php?user_id='.$user_id.'&token='.$token;

					$asunto = 'Recuperacion de contraseñas - Administracio
 					nUberDostHP';
 					$cuerpo = "Hola $nombre: !<br /><br /> Se ha solicitado un reinicio
 					de contrase&ntilde;a. <br/><br/>Para restaurar la contrse&ntilde;a,
					Da click en la siguiente direcci&oacute;n: <a href='$url'>Cambiar Contraseña</a>";

					if (enviarEmail($correo, $nombre, $asunto, $cuerpo)) {
						echo "Hemos enviado un correo a la direccion $correo para restablecer
						tu contraseña.<br/>";
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            <li class="active"><a href="#" data-nav-section="Inicio"><span>Inicio</span></a></li>
								<li><a href="#" data-nav-section="contact"><span>Recupera Contraseña</span></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Recuperar contraseña</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>Ingresa tu correo electrónico para recuperar tu cuenta.</h3>

											<div class="col-md-3 to-animate"></div>

										<div class="row row-bottom-padded-md">
											<form id="loginform" action="<?php $_SERVER['PHP_SELF'] ?>" class="col-md-6 to-animate" method="post">
												<div class="form-group">
													<label for="Correo" class="sr-onlyy">Usuario</label>
													<h1> </h1>
													<input id="correo" type="email" class="form-control" name="correo" value="" placeholder="&#128100; correo electrónico" required>
												</div>
												<h1> </h1>
												<div class="form-group ">
													<button class="btn btn-primary btn-lg" id="btn-login" type="submit" name="button">Recuperar</a>
												</div>
