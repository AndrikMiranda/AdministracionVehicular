...
$consulta = "SELECT idVehiculo, idMarca, idModelo, idColor, ano, matricula FROM vehiculo $where";
         ...
         <div class="col-md-8 col-md-offset-2 subtext to-animate">
             ...
             <form class="" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                 <h3>Buscar vehiculo</h3>
                   ...
                   <input id="matricula" class="form-control" placeholder="Matrícula" name="matricula" type="text">
                   <br>
                 ...
                 while ($row = $resultado ->fetch_array(MYSQL_ASSOC)) {
                   ...
                   $row4 = $resultado4 ->fetch_array(MYSQL_ASSOC);
                     ...
                     <tr>
                       ...
                       <td><a href="eliminarVehiculo.php?idVehiculo=<?php echo $row['idVehiculo']; ?>"onclick="return confirm('Estás seguro que deseas eliminar el registro?');"><span class="glyphicon glyphicon-trash"></span></a>
         							</tr>
                     </tr>
               <?php
                 }
