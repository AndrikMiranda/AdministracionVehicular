 				...
 				<div class="col-md-12 section-heading text-center">
 					...
 					<div class="row">
 						<div class="col-md-8 col-md-offset-2 subtext to-animate">
 							<h3>Ingresa tu nueva contraseña recuperar tu cuenta.</h3>

 									<div class="col-md-3 to-animate"></div>
 										<div class="row row-bottom-padded-md">
 											<form id="loginform" action="guarda_pass.php" class="col-md-6 to-animate" method="post">
                        <input type="hidden" id="user_id" name="user_id" value="<?php echo $user_id; ?>"/>
                        <input type="hidden" id="token" name="token" value="<?php echo $token; ?>">
 												<div class="form-group">
 													<label for="Correo" class="sr-onlyy">Contraseña</label>
 													<h1> </h1>
 													<input id="contrasena" type="password" class="form-control" name="contrasena" value="" placeholder="&#x1F512; Contraseña Nueva" required>
 												</div>
                        <div class="form-group">
 													<label for="Correo" class="sr-onlyy">Confirma contraseña</label>
 													<h1> </h1>
 													<input id="con_contrasena" type="password" class="form-control" name="con_contrasena" value="" placeholder="&#x1F512; Confirmar Contraseña" required>
 												</div>
 												<h1> </h1>
 												<div class="form-group ">
 													<button class="btn btn-primary btn-lg" id="btn-login" type="submit" name="button">Cambiar</a>
 												</div>
