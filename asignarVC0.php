       ...
       <form id="vehiculoform" role="form" action="updateVC.php" method="post" autocomplete="off" class="col-md-6 to-animate">
         ...
         <div class="form-group">
           <select class="form-control" name="idVehiculo" id="idVehiculo">
             ...
             $consulta2 = "SELECT DISTINCT * FROM vehiculo WHERE NOT EXISTS
             (SELECT idVehiculo FROM conductor WHERE conductor.idVehiculo = vehiculo.idVehiculo)";
             $resultado2 = $mysqli->query($consulta2);
             while ($row1 = $resultado2 ->fetch_array(MYSQL_ASSOC)) {
             ?>
