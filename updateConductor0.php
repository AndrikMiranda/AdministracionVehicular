...
if (!empty($_POST)) {
  ...
  $apellidosC = $mysqli->real_escape_string($_POST['apellidos']);
  $fechaNC = $mysqli->real_escape_string($_POST['fechaN']);
  $telefonoC = $mysqli->real_escape_string($_POST['telefono']);
  $direccionC = $mysqli->real_escape_string($_POST['direccion']);
  $correoC = $mysqli->real_escape_string($_POST['correo']);
  $credito = $mysqli->real_escape_string($_POST['credito']);
  $idEstadoC = $mysqli->real_escape_string($_POST['idEstado']);
  $idCiudadC = $mysqli->real_escape_string($_POST['idCiudad']);
  $idCertificado = $mysqli->real_escape_string($_POST['idCertificado']);
  $id = $mysqli->real_escape_string($_POST['idConductor']);

  if (isNullConductor($nombreC, $apellidosC, $fechaNC, $telefonoC, $direccionC, $correoC,
  $credito, $idEstadoC, $idCiudadC, $idCertificado)) {
    $errors[] = "Debe llenar todos los campos.";
  }

  $registroC = registrarConductor($nombreC, $apellidosC, $fechaNC, $telefonoC, $direccionC, $correoC,
  $credito, $idEstadoC, $idCiudadC, $idCertificado, $id);
